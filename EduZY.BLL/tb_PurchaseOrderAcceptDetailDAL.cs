...
{
	/// <summary>
	/// 数据访问类:tb_PurchaseOrderAcceptDetail
	/// </summary>
	public partial class tb_PurchaseOrderAcceptDetailDAL
	{
		
         public string DBName = "";
         public tb_PurchaseOrderAcceptDetailDAL(string db)
		{
            DBName = db;     
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [" + DBName + @"].[dbo].tb_PurchaseOrderAcceptDetail");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tb_PurchaseOrderAcceptDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append("insert into [" + DBName + @"].[dbo].tb_PurchaseOrderAcceptDetail(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tb_PurchaseOrderAcceptDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [" + DBName + @"].[dbo].tb_PurchaseOrderAcceptDetail set ");
			if (model.POId != null)
			{
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tb_PurchaseOrderAcceptDetail GetModel(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1  ");
			strSql.Append(" id,POId,ProductName,HHNo,GG,Unit,BoxNum,Num,SendNum,Price,Remark,AddTime,ProductId ");
			strSql.Append(" from [" + DBName + @"].[dbo].tb_PurchaseOrderAcceptDetail ");
			strSql.Append(" where id="+id+"" );
			Maticsoft.Model.tb_PurchaseOrderAcceptDetail model=new Maticsoft.Model.tb_PurchaseOrderAcceptDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tb_PurchaseOrderAcceptDetail DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tb_PurchaseOrderAcceptDetail model=new Maticsoft.Model.tb_PurchaseOrderAcceptDetail();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from [" + DBName + @"].[dbo].tb_PurchaseOrderAcceptDetail T ");
