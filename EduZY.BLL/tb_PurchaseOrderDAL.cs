...
{
    /// <summary>
    /// 数据访问类:tb_PurchaseOrder
    /// </summary>
    public partial class tb_PurchaseOrderDAL
    {

        public string DBName = "";
        public tb_PurchaseOrderDAL(string db)
        {
            DBName = db;
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from [" + DBName + @"].[dbo].tb_PurchaseOrder");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Maticsoft.Model.tb_PurchaseOrder model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append("insert into [" + DBName + @"].[dbo].tb_PurchaseOrder(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Maticsoft.Model.tb_PurchaseOrder model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [" + DBName + @"].[dbo].tb_PurchaseOrder set ");
            //if (model.SerialNum != null)
            //{
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.tb_PurchaseOrder GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1  ");
            strSql.Append(" id,SerialNum,SupId,SupCode,StoreId,StoreCode,Remark,Status,CreateUserName,CreateDate,ApprUserName,ApprDate,HandledUserName ");
            strSql.Append(" from [" + DBName + @"].[dbo].tb_PurchaseOrder ");
            strSql.Append(" where id=" + id + "");
            Maticsoft.Model.tb_PurchaseOrder model = new Maticsoft.Model.tb_PurchaseOrder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.tb_PurchaseOrder DataRowToModel(DataRow row)
        {
            Maticsoft.Model.tb_PurchaseOrder model = new Maticsoft.Model.tb_PurchaseOrder();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,SerialNum,SupId,SupCode,StoreId,StoreCode,Remark,Status,CreateUserName,CreateDate,ApprUserName,ApprDate,HandledUserName ");
            strSql.Append(" FROM [" + DBName + @"].[dbo].tb_PurchaseOrder ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from [" + DBName + @"].[dbo].tb_PurchaseOrder T ");
