...
namespace Maticsoft.DAL{
	 	...
	 	//tb_StockOut
		public partial class tb_StockOutDAL
	{
	     public string DBName = "";
         public tb_StockOutDAL(string db)
		{
            DBName = db;     
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [" + DBName + @"].[dbo].tb_StockOut");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tb_StockOut model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [" + DBName + @"].[dbo].tb_StockOut(");			
		...
		/// 更新一条数据
		/// </summary>
		public int  Update(Maticsoft.Model.tb_StockOut model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [" + DBName + @"].[dbo].tb_StockOut set ");
...
SqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tb_StockOut GetModel(int id)
		{
			...
			strSql.Append("  from [" + DBName + @"].[dbo].tb_StockOut ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.tb_StockOut model=new Maticsoft.Model.tb_StockOut();
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" * ");
			strSql.Append(" FROM tb_StockOut ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
	    ...
	    public DataSet GetPageList(int pageSize, int pageIndex, string strWhere, out int iRecordCount)
        {
            ...
            return DbHelperSQL.QueryPageList("[" + DBName + @"].[dbo].tb_StockOut", "id ","*", pageSize, pageIndex, "id desc ", strWhere, out iRecordCount);
        }
