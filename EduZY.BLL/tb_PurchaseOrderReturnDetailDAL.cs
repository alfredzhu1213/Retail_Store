...
{
	/// <summary>
	/// 数据访问类:tb_PurchaseOrderReturnDetail
	/// </summary>
	public partial class tb_PurchaseOrderReturnDetailDAL
	{

        public string DBName = "";
        public tb_PurchaseOrderReturnDetailDAL(string db)
        {
            DBName = db;
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "[" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tb_PurchaseOrderReturnDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append("insert into [" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tb_PurchaseOrderReturnDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail set ");
			if (model.POId != null)
			{
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tb_PurchaseOrderReturnDetail GetModel(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1  ");
			strSql.Append(" id,POId,ProductName,HHNo,GG,Unit,BoxNum,Num,SendNum,Price,Remark,AddTime,ProductId ");
			strSql.Append(" from [" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail ");
			strSql.Append(" where id="+id+" " );
			Maticsoft.Model.tb_PurchaseOrderReturnDetail model=new Maticsoft.Model.tb_PurchaseOrderReturnDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tb_PurchaseOrderReturnDetail DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tb_PurchaseOrderReturnDetail model=new Maticsoft.Model.tb_PurchaseOrderReturnDetail();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from [" + DBName + @"].[dbo].tb_PurchaseOrderReturnDetail T ");
