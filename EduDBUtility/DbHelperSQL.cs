...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        /// <returns>DataSet</returns>
        public static void RunProcedure(string storedProcName, IDataParameter[] parameters, out DataSet dataSet)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <returns></returns>
        public static DataSet QueryPageList(string TableName, string FieldKey, string FieldShow, int iPageSize, int iCurrentPage, string sColumnOrder, string sWhere, out int iRecordCount)
        {
            DataSet objDs;
            ...
            SqlParameter[] parameters ={ 
				 ...
				 new SqlParameter("@FieldShow",SqlDbType.NVarChar,2000),
            ...
            objDs = RunProcedure("dbo.UP_GetRecordByPage", parameters, TableName);
