...
{
	/// <summary>
	/// tb_PurchaseOrderAccept:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class tb_PurchaseOrderAccept
	{
		public tb_PurchaseOrderAccept()
		{}
		#region Model
		private int _id;
		private string _serialnum;
		private string _orderserialnum;
		private int? _supid;
		...
		{
			set{ _orderserialnum=value;}
			get{return _orderserialnum;}
		}
		/// <summary>
		/// 供应商id
		/// </summary>
