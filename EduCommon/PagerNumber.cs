...
namespace Common
{
    ...
    {//定义一个委托
        ...
        public PagerNumber(string sPageName,string sWebUrl)
        {
            WebUrl = sWebUrl;
            PageName = sPageName;
        }
        public  string Pager(int count, int iPageSize, int pageindex)
        {
            return FunPager(count,iPageSize, pageindex, PageAA);
        }
        private string PageAA(int iCurrentPage)
        {
            return "href='" + PageName + "?pageindex=" + iCurrentPage + this.WebUrl + "'";
        }
        ...
        public string FunPager_New(int count, int iPageSize, int iCurrentPage, ProcessDelegate process, ProcessDelegate processPageSize = null)
        {
            ...
            {
                str += "<A style='MARGIN-RIGHT: 5px' disabled><<</A><A style='MARGIN-RIGHT: 5px' disabled><</A><SPAN style='MARGIN-RIGHT: 5px' class=current>1</SPAN><A style='MARGIN-RIGHT: 5px' disabled>></A><A style='MARGIN-RIGHT: 5px' disabled>>></A>";
            }
            else if (pagernum1 <= 10)
            {
                #region
                if (iCurrentPage == 1)
                {
                    str += "<A style='MARGIN-RIGHT: 5px' disabled><<</A><A style='MARGIN-RIGHT: 5px' disabled><</A>";
                    for (int i = 1; i <= pagernum1; i++)
                    {
                        if (iCurrentPage == i)
                        {
                            str += "<SPAN style='MARGIN-RIGHT: 5px' class=current>" + i + "</SPAN>";
                        }
                        else
                        {
                            str += "<A style='MARGIN-RIGHT: 5px' " + PageA(i, process) + ">" + i + "</A>";
                        }
                    }
                    str += "<A style='MARGIN-RIGHT: 5px' " + PageA(iCurrentPage + 1, process) + ">></A><A style='MARGIN-RIGHT: 5px'  " + PageA(pagernum1, process) + " >>></A>";
                }
                else if (iCurrentPage < pagernum1)
                {
                    str += "<A style='MARGIN-RIGHT: 5px' " + PageA(1, process) + "><<</A><A style='MARGIN-RIGHT: 5px' " + PageA(iCurrentPage - 1, process) + "><</A>";
                    for (int i = 1; i <= pagernum1; i++)
                    {
                        if (iCurrentPage == i)
                        {
            ...
            else if (pagernum1 > 10)
            {
                ...
                if (iCurrentPage == 1)
                {
                    ...
                    for (int i = 1; i <= 11; i++)
                    {
                        if (i == 11)
                        {
                            str += "<A style='MARGIN-RIGHT: 5px' " + PageA(i, process) + ">...</A>";
                        }
                        else
                        {
                            if (iCurrentPage == i)
                ...
                else if (iCurrentPage < pagernum1)
                {
                    ...
                    if (pagernum1 > (j * 10 + 11))
                    {
                        str += "<A style='MARGIN-RIGHT: 5px' " + PageA(1, process) + "><<</A><A style='MARGIN-RIGHT: 5px' " + PageA(iCurrentPage - 1, process) + "><</A><A style='MARGIN-RIGHT: 5px' " + PageA(j * 10 == 0 ? 1 : j * 10, process) + ">...</A>";
                        for (int i = j * 10 + 1; i <= j * 10 + 10; i++)
                        {
                            if (iCurrentPage == i)
                            {
                        ...
                        str += "<A style='MARGIN-RIGHT: 5px' " + PageA(j * 10 + 11, process) + ">...</A>";
                    }
                    else
                    {
                        str += "<A style='MARGIN-RIGHT: 5px' " + PageA(1, process) + "><<</A><A style='MARGIN-RIGHT: 5px' " + PageA(iCurrentPage - 1, process) + "><</A><A style='MARGIN-RIGHT: 5px' " + PageA(j * 10 == 0 ? 1 : j * 10, process) + ">...</A>";
